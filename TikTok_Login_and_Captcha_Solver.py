# Get your key from https://rapidapi.com/oceanrock/api/tiktok-captcha-solver4
# In case you need support send us a message on the link given above
    ...
    if len(captcha_rotation) > 0:
        for i in range(1, 30):
            ...
            if len(captcha_rotation) > 0:
                ...
                url = "https://tiktok-captcha-solver4.p.rapidapi.com/rotate"
                ...
                headers = {
                    ...
                    "X-RapidAPI-Host": "tiktok-captcha-solver4.p.rapidapi.com"
                }
                ...
                if len(solve_captcha_response) > 1:
                    ...
                    for i in range(0, 1):
                        move = x * 1.5
                        #Or use the following line if an error in rotate captcha
                        #move = x * 0.65 * 2.1
    ...
    if len(captcha_3D) > 0 and len(slide_image) == 0:
        for i in range(1, 30):
            ...
            if len(captcha_3D) > 0:
                ...
                url = "https://tiktok-captcha-solver4.p.rapidapi.com/objects"
    ...
    if len(captcha_puzzle) > 0:
        for i in range(1, 30):
            ...
            if len(captcha_puzzle) > 0:
                ...
                url = "https://tiktok-captcha-solver4.p.rapidapi.com/slide"
